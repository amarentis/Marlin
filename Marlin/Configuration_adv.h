...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 50*60, 50*60 } // Feedrates for manual moves along X, Y, Z, E from panel
  #define SHORT_MANUAL_Z_MOVE 0.001 // (mm) Smallest manual Z move (< 0.1mm)
